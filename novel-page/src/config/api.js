// API 基础配置
const protocolUrl = window.location.protocol === 'https:' ? 'https://novel.wangpl.cn/api' : 'http://127.0.0.1:30000/api';
...
// WebSocket 配置
const websocketProtocolUrl = window.location.protocol === 'https:' ? 'wss://novel.wangpl.cn/ws' : 'ws://127.0.0.1:30000/ws';
